...
<div id="list-article" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tbody>
        <g:each in="${articleList}" status="i" var="articleInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">

                <td><g:link action="update" controller="content" id="${articleInstance.id}">${fieldValue(bean: articleInstance, field: "title")}</g:link></td>
