	...
	<body>
		...
		<div id="show-category" class="content scaffold-show" role="main">
			...
			<ol class="property-list category">
				...
				<g:if test="${categoryInstance?.urlId}">
				<li class="fieldcontain">
					<span id="urlId-label" class="property-label"><g:message code="category.urlId.label" default="Url Id" /></span>
					
						<span class="property-value" aria-labelledby="urlId-label"><g:fieldValue bean="${categoryInstance}" field="urlId"/></span>
				...
				<g:if test="${categoryInstance?.isValid}">
				<li class="fieldcontain">
					<span id="isValid-label" class="property-label"><g:message code="category.isValid.label" default="Is Valid" /></span>
					
						<span class="property-value" aria-labelledby="isValid-label"><g:formatBoolean boolean="${categoryInstance?.isValid}" /></span>
