		...
		<div id="list-category" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="urlId" title="${message(code: 'category.urlId.label', default: 'Url Id')}" />
					
						<g:sortableColumn property="dateCreated" title="${message(code: 'category.dateCreated.label', default: 'Date Created')}" />
					
						<g:sortableColumn property="isValid" title="${message(code: 'category.isValid.label', default: 'Is Valid')}" />
				...
				<g:each in="${categoryInstanceList}" status="i" var="categoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: categoryInstance, field: "urlId")}</td>
					
						<td><g:formatDate date="${categoryInstance.dateCreated}" /></td>
					
						<td><g:formatBoolean boolean="${categoryInstance.isValid}" /></td>
